          ...
          <tbody>
            <tr className="border-b bg-white hover:bg-gray-50 transition-colors">
              ...
              <td className="px-3 md:px-6 py-3 md:py-4 text-center text-blue-600 font-semibold text-sm md:text-base">
                +{((parseFloat(result?.quantum || "0") - parseFloat(result?.classical || "0"))
                  / parseFloat(result?.classical || "1") * 100).toFixed(1)}%
              </td>
            </tr>
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Ports face berth congestion, crane idle time, and yard bottlenecks. Q-Porter™ uses{" "}
            <span className="font-semibold text-blue-600">Hybrid Quantum + AI optimization</span>{" "}
            to reduce waiting times, emissions, and operational costs while improving overall throughput.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-4 md:p-6">
            ...
            <p className="mt-2 opacity-90 text-sm md:text-base">
              Experience the power of quantum-enhanced logistics optimization
            </p>
          </div>
