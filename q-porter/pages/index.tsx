  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          content="Q-Porter delivers hybrid quantum-classical AI solutions that optimize port and airport logistics, reducing delays and improving throughput with cutting-edge quantum algorithms."
          name="description"
        />
        <meta property="og:url" content="https://q-porter.com" />
        <meta
          property="og:description"
          content="Q-Porter's hybrid quantum-classical AI optimizes port and airport logistics, delivering measurable efficiency gains through advanced algorithms."
        />
